...
static void __fastcall__ draw_cutscene_part(void)
{
...

    {
        ...
        // top
        ppu_begin_tile_batch(NAMETABLE_0_BASE, ALIGN_SCREEN_WIDTH_LEFT(0), ALIGN_SCREEN_HEIGHT_CENTER_TOP(8));
        ppu_push_tile_batch(CHR_SPRITE(CHR_ROM_00_HUD_PNG_SPRITE, SPRITE_BORDER_TOP_LEFT));
        ppu_end_tile_batch();

        ppu_repeat_tile_batch(NAMETABLE_0_BASE, ALIGN_SCREEN_WIDTH_LEFT(1), ALIGN_SCREEN_HEIGHT_CENTER_TOP(8), CHR_SPRITE(CHR_ROM_00_HUD_PNG_SPRITE, SPRITE_BORDER_TOP_CENTER), SCREEN_WIDTH - 3);

        ppu_begin_tile_batch(NAMETABLE_0_BASE, ALIGN_SCREEN_WIDTH_RIGHT(1), ALIGN_SCREEN_HEIGHT_CENTER_TOP(8));
        ppu_push_tile_batch(CHR_SPRITE(CHR_ROM_00_HUD_PNG_SPRITE, SPRITE_BORDER_TOP_RIGHT));
        ppu_end_tile_batch();

        // bottom
        ppu_begin_tile_batch(NAMETABLE_0_BASE, ALIGN_SCREEN_WIDTH_LEFT(0), ALIGN_SCREEN_HEIGHT_CENTER_BOTTOM(8));
        ppu_push_tile_batch(CHR_SPRITE(CHR_ROM_00_HUD_PNG_SPRITE, SPRITE_BORDER_BOTTOM_LEFT));
        ppu_end_tile_batch();

        ppu_repeat_tile_batch(NAMETABLE_0_BASE, ALIGN_SCREEN_WIDTH_LEFT(1), ALIGN_SCREEN_HEIGHT_CENTER_BOTTOM(8), CHR_SPRITE(CHR_ROM_00_HUD_PNG_SPRITE, SPRITE_BORDER_BOTTOM_CENTER), SCREEN_WIDTH - 3);

        ppu_begin_tile_batch(NAMETABLE_0_BASE, ALIGN_SCREEN_WIDTH_RIGHT(1), ALIGN_SCREEN_HEIGHT_CENTER_BOTTOM(8));
